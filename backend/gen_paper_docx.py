...
def build() -> str:
    ...
    P(doc,
      ...
      "evaluated at four levels of increasing realism: 558 automated component "
      ...
      "methods; and a fully-wired four-condition component-attribution ablation. "
    ...
    NUMBERED(doc, [
        ...
        "A reproducibility package — 558 component tests, a content-hashed 25-task "
    ...
    P(doc, "The automated suite reports 558 passed and 5 skipped (the skips require "
    ...
    H(doc, "6.5 Thermodynamic model-form uncertainty (live)", 2)
    P(doc, "A water-heater flowsheet solved under Peng-Robinson, Soave-Redlich-"
           ...
           "0.07%, reported as robust - because DWSIM applies a corrected "
           "liquid-density model across packages. The capability reports robustness "
           "truthfully rather than manufacturing sensitivity; the model-dependent "
           "path (large spread, most-sensitive output identified) is covered by "
           "unit tests, and the comparison packages are auto-selected for the "
           "chemistry.", align="justify")
    H(doc, "6.6 Live 25-task benchmark", 2)
    P(doc, "Run crash-isolated (one subprocess per task) against the live engine, "
           ...
           "water-heater and pump tasks passing cleanly against live physics. This "
           "figure is quota- and scoring-limited and is not presented as a clean "
           "capability ceiling.", align="justify")
    H(doc, "6.7 Component-attribution ablation", 2)
    ...
    LEAD(doc, "What is established. ",
         "The system is designed, implemented, component-validated (558 tests), "
